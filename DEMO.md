...
**Note:** `data/language_names.json` is a static reference file already included in the repository with language name mappings.
...
The `data/language_names.json` is a static reference file containing mappings like:
...
This file is included in the repository and serves as a reference for language names.
